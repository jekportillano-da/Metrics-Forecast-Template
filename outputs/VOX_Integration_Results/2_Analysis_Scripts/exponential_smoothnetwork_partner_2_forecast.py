...
print("=== EXPONENTIAL SMOOTHING FORECAST WITH VOX-Network_Partner_2 ===")
print()
...
# VOX-Network_Partner_2 specific forecasting
def forecast_vox_ing(aug_value, sep_value, periods=4):
    """Forecast VOX-Network_Partner_2 based on their growth pattern"""
...
print("=== BASELINE FORECASTING (WITHOUT VOX-Network_Partner_2) ===")
...
# Forecast baseline (without VOX-Network_Partner_2) Oct-Dec 2025
...
print("=== VOX-Network_Partner_2 FORECASTING ===")

# Forecast VOX-Network_Partner_2 Oct-Dec 2025
...
print("VOX-Network_Partner_2 Forecasts (Oct-Dec 2025):")
...
print("=== COMBINED FORECASTS (WITH VOX-Network_Partner_2) ===")
...
print("2. VOX-Network_Partner_2 stabilizing at high levels (~$3M+ monthly)")
print("3. VOX-Network_Partner_2 maintaining 35-40% share of total business")
